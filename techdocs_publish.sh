...
techdocs-cli publish --publisher-type awsS3 --storage-name techdocs  --awsEndpoint http://minio.home.local:9000 --awsS3ForcePathStyle --entity alpha/Component/surfersapi
